...
//Tc# 159554 - Box Management System- DWELL TAB- PRECONDITION TEST CASE (for Outgated Trailer Summary Screen)
using(DataProvider.Tc_159554, async function (data) {

    describe("DWELL TAB- Outgated Trailer Summary Screen", function () {
        let loadNumber;
