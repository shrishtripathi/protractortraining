...
//Tc# 158548 - Box Management System App- DWELL TAB- VIEW SIMON RULES (via De-ramped Trailer Summary Screen)
using(DataProvider.Tc_158548, async function (data) {

    describe("DWELL TAB- View simon rules via de-ramped summary screen", function () {
        let loadNumber;
