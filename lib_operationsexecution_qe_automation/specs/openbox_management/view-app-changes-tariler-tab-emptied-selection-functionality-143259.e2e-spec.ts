...
//Tc# 143259 - Box Management- VIEW APP CHANGES- TRAILER TAB- 'EMPTIED' SELECTION FUNCTIONALITY (BOX MANAGMENT APP)
using(DataProvider.Tc_143259, async function (data) {

    describe("View app changes tariler tab emptied selection functionality", function () {
