...
//Tc# 142992 - Box Management- VIEW SIMON RULES DATA- TRAILER TAB- 'EMPTIED' SELECTION FUNCTIONALITY (BOX MANAGMENT APP)
using(DataProvider.Tc_142992, async function (data) {

    describe("View simon rules data tariler tab emptied selection functionality", function () {
        ...
        it("Should hover on action and click on simon rules", async () => {
