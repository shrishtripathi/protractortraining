...
//Tc# 160082 - Box Management System App- DWELL TAB- ADD ORDER COMMENT (via OUTGATED Trailer Summary Screen)
using(DataProvider.Tc_160082, async function (data) {

    describe("DWELL TAB- Add order comments via Outgated trailer", function () {
        let loadNumber;
        let randomText;
