...
//Tc# 143260 - Box Management- VIEW ORDER COMMENTS- TRAILER TAB- 'EMPTIED' SELECTION FUNCTIONALITY (BOX MANAGMENT APP)
using(DataProvider.Tc_143260, async function (data) {

    describe("View order comments tariler tab emptied selection functionality", function () {
