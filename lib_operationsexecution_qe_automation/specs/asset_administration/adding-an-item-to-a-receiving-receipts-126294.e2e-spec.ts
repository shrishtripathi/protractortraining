...
//TC #126294: Maximo_7 Adding an item to a Receiving Receipts
using(DataProvider.Tc_126294, async function (data) {
    let prNumber = null;
    let prNumber1 = null;

    describe("Adding an item to a Receiving Receipts", () => {
