...
//Tc #125836 - IPAY_Regression_15 Outside Shuttle Order Summary
using(DataProvider.Tc_125836, async function (data) {

    describe("IPAY_Regression_15 Outside Shuttle Order Summary", function () {
        ...
        it("Should click on Outside Shuttle Order Summary under the Workflow Menu", async () => {
            await iPayHomePage.clickOnLinkMenu(data.outsideShuttleOrderSummaryLink);
        });
