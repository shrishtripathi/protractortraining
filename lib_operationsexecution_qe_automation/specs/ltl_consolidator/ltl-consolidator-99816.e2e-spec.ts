...
let orderNumber_TC_99816: string = null;

let using = require('jasmine-data-provider');

//TC#99816 -LTL Consolidator_Regression_1 2 orders
using(DataProvider.Tc_99816, async function (data) {
    describe("LTL Consolidator_Regression_1 2 orders", () => {
        ...
        it("Should create 'Order Number'", async () => {
            ...
            orderNumber_TC_99816 = orderNumber;
            console.log("order num i9s " + orderNumber_TC_99816)
        ...
        it("Should enter 'Order Number'", async () => {
            await eomPage.setValueInSearchInputBox(orderNumber_TC_99816);
        });
        it("Should click 'Search Loads'", async () => {
            await eomPage.clickSearchLoadsButton();
        });
        it("Should click on 'order number link'", async () => {
            await eomPage.clickOnOrderNumberLink(orderNumber_TC_99816);
        });
