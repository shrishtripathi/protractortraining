...
//TC #131787: EOM_Regression_33 Using Hot Keys to Exit
using(DataProvider.Tc_131787, async function (data) {

    describe("Using Hot Keys to Exit", () => {
        ...
        //TC131787
        it("Should press ALT x key", async () => {
            new ActionSequence(browser.driver).keyDown(protractor.Key.ALT).sendKeys("x").keyUp(protractor.Key.ALT).perform();
            await browser.sleep(10000)
        });
        ...
        it("Should press ALT F9 key", async () => {
            new ActionSequence(browser.driver).keyDown(protractor.Key.ALT).sendKeys("F9").keyUp(protractor.Key.ALT).perform();
            await browser.sleep(10000)
        });

        it("Should press ALT F1 key", async () => {
            new ActionSequence(browser.driver).keyDown(protractor.Key.ALT).sendKeys("F1").keyUp(protractor.Key.ALT).perform();
            await browser.sleep(10000)
        });
    });
});