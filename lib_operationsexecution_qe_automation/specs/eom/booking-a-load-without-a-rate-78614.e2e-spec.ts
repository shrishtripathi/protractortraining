...
//TC #78614: EOM_Regression_3 Booking a load with out a rate
using(DataProvider.Tc_78614, async function (data) {

    describe("Booking a load with Out a rate", () => {
        ...
        it(" In the COMMENT box type TEST1234", async () => {
        ...
        it("Should click on Create Load button", async () => {
            ...
            let laodnumber: string = await detailsPage.loadNumber();
