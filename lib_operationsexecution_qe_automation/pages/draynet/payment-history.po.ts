...
export class PaymentHistoryPage extends BasePage {
    readonly divisionDropdown:string="//span[text()='Divison:']//ancestor::div[@class='icePnlClpsblCnt']//tr[2]//td[2]//select//option";
    readonly projectDropdown:string="//span[text()='Project:']//ancestor::div[@class='icePnlClpsblCnt']//tr[2]//td[3]//select//option";
    readonly carrierDropdown:string="//span[text()='Carrier: ']//ancestor::div[@class='icePnlClpsblCnt']//tr[2]//td[4]//select//option";
    readonly searchButton:ElementFinder=element(by.xpath("//button[text()='Search']"));
    readonly startDate:ElementFinder=element(by.xpath("//span[text()='Date Range:']//ancestor::div[@class='icePnlClpsblCnt']//tr[2]//td[1]//tr//td[1]//input[@class='iceSelInpDateInput']"));
    readonly endDate:ElementFinder=element(by.xpath("//span[text()='Date Range:']//ancestor::div[@class='icePnlClpsblCnt']//tr[2]//td[2]//input[@class='iceSelInpDateInput']"));
    public async selectDivision(value:any){
        let ele:ElementFinder=element(by.xpath("//span[text()='Divison:']//ancestor::div[@class='icePnlClpsblCnt']//tr[2]//td[2]//select//option"));
    ...
    public async verifyPaymnetHistoryResults(){
        let rows=element.all(by.xpath("//span[text()='Invoice Number']//ancestor::tr[2]//tbody//tr"));
