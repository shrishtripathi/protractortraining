...
export class DeliveryPage extends BasePage {
    ...
    readonly textFleetType2 = element(by.xpath("//table[@id='form:fleetType']//td[2]/input"));
    readonly textFleetType3 = element(by.xpath("//table[@id='form:fleetType']//td[3]/input"));
    readonly textFleetType4 = element(by.xpath("//table[@id='form:fleetType']//td[4]/input"));
    ...
    public async setSearchParameters(strType: string, strDivison: string, strAreaType: string, strArea: string, strFleetType: string) {
        ...
        if (strFleetType.length >= 1) {
            ...
            await this.actions.clearText(this.textFleetType2, "Fleet Type");
            await this.actions.clearText(this.textFleetType3, "Fleet Type");
            await this.actions.clearText(this.textFleetType4, "Fleet Type");
            console.log("strFleetType:"+strFleetType);
    ...
    public async verifySearchResults(strArea: string) {
        let resultArray;
        let rowCount = await this.tableSearch.count();
