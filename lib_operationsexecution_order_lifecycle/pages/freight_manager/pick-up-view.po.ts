...
export class PickupviewPage extends BasePage {
    ...
    readonly divisionParameter: ElementFinder=element(by.xpath("//input[@value='HJBT JBVAN']"));
    readonly areaTypeParameter: ElementFinder=element(by.xpath("//input[@value='MKT']"));;
    readonly areaParameter: ElementFinder=element(by.xpath("//input[@value='DA']"));;
    readonly mdParameter: ElementFinder=element(by.xpath("//input[@value='I']"));;
    ...
    readonly successOrErrorMessage = element(by.xpath("//div[@id='innerContent']//li//span"));
    ...
    readonly areaType = element(by.xpath("//table[@id='form:areaType']//tr/td[1]/input"));
    readonly trandMd1 = element(by.xpath("//table[@id='form:transitMode']//tr/td[1]/input"));
    readonly trandMd2 = element(by.xpath("//table[@id='form:transitMode']//tr/td[2]/input"));
    ...
    public async waitForResult() {
        // let loading: ElementFinder = element(by.xpath("//*[contains(@id,'connection-working') and @style='visibility: hidden;']"));
        await this.actions.waitUntilElementPresenceOf(this.loadingIcon)
    };
    ...
    public async enterAreaType(text) {
        ...
        await this.actions.setText(this.areaType, text, 'Entering value for Area Type');
    }
    ...
    public async enterTranMd(text: string) {
        await this.actions.clearText(this.multiInputText("transitMode", 1), "clear");
        await this.actions.clearText(this.multiInputText("transitMode", 2), "clear");
        await this.actions.setText(this.trandMd1, text, 'Entering value for Enter Md textbpx');
    }
    ...
    public async verifyErrorMessage() {
        let text = await this.actions.getText(this.successOrErrorMessage, "Please select atleast one order");
        return text;
    }
    ...
    public async hoverOverOrderNumberDropDown() {
        try {
            let toolTip: ElementFinder = await element(by.xpath("//div[@class='icePnlTlTip' and .//text()='ORDER STOPS']"));
            if (await toolTip.isPresent()) {
                await this.actions.moveMouseToElement(toolTip, "mouse move to logo")
            }
        } catch (error) {
            console.log(error)
        }
    ...
    public async clickOnDropDownOptionInOrderNumber(rowIndex: number, orderNumberDropDownOption: string) {
        await this.hoverOverOrderNumberDropDown();
    ...
    public async clickWhiteColorBoxWithEmptyBox() {
        ...
        let colorBox = "//td[" + pwrDrvrNotesColumnIndex + "]/input[@value='']/ancestor::tr/td[" + colorBoxColumnIndex + "]/div[@class='icePnlGrp WOF_STANDARD_ACCOUNT']"
