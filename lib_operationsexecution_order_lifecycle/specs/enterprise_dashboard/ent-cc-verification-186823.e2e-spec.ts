...
//TC #186823: ENT CC Verification
using(DataProvider.Tc_186823, async function (data) {
    ...
    describe("ENT CC Verification", () => {
        ...
        it("Verifying That There Is Date And Time Under Train ETA ", async () => {
            await expect<any>(appointmentsPage.verifyingDateAndTimeUnderTrainEta()).not.toBe(null);          
        });
    });
});